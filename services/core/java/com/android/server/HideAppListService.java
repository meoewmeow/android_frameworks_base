...
/**
 * Prunes uninstalled packages from Settings.Secure.HIDE_APPLIST.
 *
 * <p>Adapted from Infinity X (frameworks_base@16-QPR1,
 * services/core/java/com/android/server/HideAppListService.java, itself from
 * AxionAOSP). No functional changes.
 */
